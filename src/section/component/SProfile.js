                ...
                <div>
                 <div className="prfe-cor">
                       ...
                       <div className="prfe-flw">
                        ...
                        <div className="clb-reg "> 
                        {this.props.data.checkkUser? <div className="d-flex justify-content-start align-items-center mt-1">
                            <Link to={`/editprofile/${this.props.data.allData.username}`}><button style={{background: "none",color: "#FFC107"}}>ویرایش</button> </Link>
                        <div>
                        <span className="signout" onClick={()=>logout()}></span>
                        </div>
                        </div>
                        :
